<x-app-layout>
    <div class="max-w-4xl mx-auto">
        <div class="mb-6">
            <a href="{{ route('students.index') }}" class="inline-flex items-center gap-x-2 text-sm font-semibold text-primary-900 hover:text-primary-700">
                ...
                <div class="space-y-6">
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div>
                            ...
                            <div class="mt-2">
                                <input type="text" name="first_name" id="first_name" value="{{ old('first_name', $student->first_name ?? '') }}" required class="block w-full rounded-md border-0 py-2.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-900 sm:text-sm sm:leading-6 @error('first_name') ring-red-500 @enderror">
                            </div>
                            @error('first_name')
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <input type="text" name="last_name" id="last_name" value="{{ old('last_name', $student->last_name ?? '') }}" required class="block w-full rounded-md border-0 py-2.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-900 sm:text-sm sm:leading-6 @error('last_name') ring-red-500 @enderror">
                            </div>
                            @error('last_name')
                                <p class="mt-1.5 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div>
                            ...
                            <div class="mt-2">
                                <input type="email" name="email" id="email" value="{{ old('email', $student->email ?? '') }}" class="block w-full rounded-md border-0 py-2.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-900 sm:text-sm sm:leading-6 @error('email') ring-red-500 @enderror" placeholder="john@example.com">
                            </div>
                            @error('email')
                                <p class="mt-1.5 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <input type="tel" name="phone" id="phone" value="{{ old('phone', $student->phone ?? '') }}" class="block w-full rounded-md border-0 py-2.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-900 sm:text-sm sm:leading-6 @error('phone') ring-red-500 @enderror" placeholder="+1 (555) 000-0000">
                            </div>
                            @error('phone')
                                <p class="mt-1.5 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div>
                            <label for="source" class="block text-sm font-semibold leading-6 text-gray-900">Student Source</label>
                            <div class="mt-2">
                                <select name="source" id="source" class="block w-full rounded-md border-0 py-2.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-primary-900 sm:text-sm sm:leading-6 @error('source') ring-red-500 @enderror">
                                    ...
                                    <option value="website" {{ old('source', $student->source ?? '') === 'website' ? 'selected' : '' }}>Website</option>
                                    <option value="referral" {{ old('source', $student->source ?? '') === 'referral' ? 'selected' : '' }}>Referral</option>
                                    <option value="social_media" {{ old('source', $student->source ?? '') === 'social_media' ? 'selected' : '' }}>Social Media</option>
                                    <option value="email" {{ old('source', $student->source ?? '') === 'email' ? 'selected' : '' }}>Email Campaign</option>
                                    <option value="walk_in" {{ old('source', $student->source ?? '') === 'walk_in' ? 'selected' : '' }}>Walk In</option>
                                    <option value="phone" {{ old('source', $student->source ?? '') === 'phone' ? 'selected' : '' }}>Phone Call</option>
                                    <option value="event" {{ old('source', $student->source ?? '') === 'event' ? 'selected' : '' }}>Event</option>
                                </select>
                            </div>
                            @error('source')
                                <p class="mt-1.5 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <select name="status" id="status" required class="block w-full rounded-md border-0 py-2.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-primary-900 sm:text-sm sm:leading-6 @error('status') ring-red-500 @enderror">
                                    ...
                                    <option value="lost" {{ old('status', $student->status ?? '') === 'lost' ? 'selected' : '' }}>Lost</option>
                                </select>
                            </div>
                            @error('status')
                                <p class="mt-1.5 text-sm text-red-600">{{ $message }}</p>
