<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600">Operations overview and management</p>
        </div>
    ...
    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        <div class="relative overflow-hidden rounded-xl bg-white px-6 py-5 shadow-soft hover:shadow-soft-lg transition-shadow duration-200">
            <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        <dt class="truncate text-sm font-medium text-gray-500">All Leads</dt>
        ...
        <div class="relative overflow-hidden rounded-xl bg-white px-6 py-5 shadow-soft hover:shadow-soft-lg transition-shadow duration-200">
            <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        <dt class="truncate text-sm font-medium text-gray-500">All Students</dt>
                        <dd class="flex items-baseline">
            ...
            <div class="border-b border-gray-200 px-6 py-5">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">Latest potential clients</p>
                    </div>
                    <a href="{{ route('leads.index') }}" class="text-sm font-semibold text-primary-500 hover:text-primary-700">View all</a>
                </div>
            </div>
            ...
            <div class="border-b border-gray-200 px-6 py-5">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">Latest enrolled students</p>
                    </div>
                    <a href="{{ route('students.index') }}" class="text-sm font-semibold text-primary-500 hover:text-primary-700">View all</a>
                </div>
            </div>
                ...
                <div class="px-6 py-4 hover:bg-gray-50 transition-colors duration-150">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center min-w-0 flex-1">
                            ...
                            <div class="ml-4 min-w-0 flex-1">
                                <p class="text-sm font-semibold text-gray-900 truncate">{{ $student->first_name }} {{ $student->last_name }}</p>
                                <p class="text-sm text-gray-500 truncate">{{ $student->email }}</p>
                            </div>
                        </div>
                        <div class="ml-4 flex-shrink-0">
                            <a href="{{ route('students.form', $student) }}" class="text-primary-600 hover:text-primary-900 text-sm font-medium">View</a>
                        </div>
                    </div>
                </div>
                @empty
    ...
    <div class="rounded-xl bg-white shadow-soft">
        <div class="border-b border-gray-200 px-6 py-5">
            ...
            <p class="mt-1 text-sm text-gray-500">Next scheduled meetings</p>
        </div>
        <div class="divide-y divide-gray-200">
            ...
            <div class="px-6 py-4 hover:bg-gray-50 transition-colors duration-150">
                <div class="flex items-center justify-between">
                    ...
                    <div class="ml-4 flex-shrink-0">
                        <a href="{{ route('appointments.index') }}" class="text-primary-600 hover:text-primary-900 text-sm font-medium">View</a>
                    </div>
                </div>
            </div>
            @empty
