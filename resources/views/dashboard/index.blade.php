        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <div class="bg-white overflow-hidden shadow-sm ring-1 ring-gray-200 rounded-lg">
                ...
                <div class="bg-gray-50 px-6 py-3">
                    <a href="{{ route('leads.index') }}" class="text-sm font-medium text-primary-900 hover:text-primary-700">View all</a>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm ring-1 ring-gray-200 rounded-lg">
                ...
                <div class="bg-gray-50 px-6 py-3">
                    <a href="{{ route('students.index') }}" class="text-sm font-medium text-primary-900 hover:text-primary-700">View all</a>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm ring-1 ring-gray-200 rounded-lg">
                ...
                <div class="bg-gray-50 px-6 py-3">
                    <a href="{{ route('appointments.index') }}" class="text-sm font-medium text-primary-900 hover:text-primary-700">View all</a>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm ring-1 ring-gray-200 rounded-lg">
                ...
                <div class="bg-gray-50 px-6 py-3">
                    <a href="{{ route('universities.index') }}" class="text-sm font-medium text-primary-900 hover:text-primary-700">View all</a>
                </div>
            </div>
        </div>
    </div>
